    ...
    <div class="p-4 ml-64 bg-[#A7CCED]">
        ...
        <div class="mx-10 p-8 w-lg bg-[#66a6df] rounded-md">
            <form action="{{ url('forminsert') }}" method="POST">
                ...
                <input class="form-control block my-3 w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500" type="text" name="namabarang" id="namabarang" required value="{{ old('namabarang') }}">
                
                <label class="text-md font-semibold" for="kategori_id">Kategori Barang :</label>
                ...
                <input class="block my-3 w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500" type="number" name="harga" id="harga" required>
                ...
                <input class="block my-3 w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500" type="number" name="stok" id="stok" required>
