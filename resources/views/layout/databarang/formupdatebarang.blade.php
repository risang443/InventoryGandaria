    ...
    <div class="p-4 ml-64 bg-[#A7CCED]">
        ...
        <div class="mx-10 p-8 w-lg bg-[#66a6df] rounded-md">
            <form action="{{ route('product.update', $product->id) }}" method="POST">
                ...
                <input class="form-control block my-3 w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500" type="text" name="namabarang" id="namabarang" required value="{{ $product->namabarang }}">
                
                <label class="text-sm font-semibold" for="kategori_id">Kategori Sepatu :</label>
                ...
                <input class="block my-3 w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500" type="number" name="harga" id="harga" required value="{{ $product->harga }}">
                ...
                <input class="block my-3 w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500" type="number" name="stok" id="stok" required value="{{ $product->stok }}">
                
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto px-5 py-2.5 text-center">Ubah</button>
