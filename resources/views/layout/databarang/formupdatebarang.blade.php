    ...
    <div class="p-4 ml-64 bg-[#A7CCED]">
        ...
        <div class="mx-10 p-8 w-lg bg-[#66a6df] rounded-md">
            <form action="{{ route('product.update', $product->id) }}" method="POST">
                ...
                <input class="form-control block my-5 w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500" type="text" name="namabarang" id="namabarang" required value="{{ $product->namabarang }}">
                ...
                <select name="kategori_id" id="kategori_id" class="bg-gray-50 border my-5 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                    ...
                    <option value="2" {{ $product->kategori_id == 2 ? 'selected' : '' }}>Formal</option>
                    <option value="3" {{ $product->kategori_id == 3 ? 'selected' : '' }}>Sport</option>
                ...
                <input class="block my-5 w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500" type="number" name="harga" id="harga" required value="{{ $product->harga }}">
                
                <label class="text-md font-semibold" for="ketersediaan">Ketersediaan :</label>
                <select name="ketersediaan" id="ketersediaan" class="bg-gray-50 border my-5 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                ...
                <input class="block my-5 w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500" type="number" name="stok" id="stok" required value="{{ $product->stok }}">
