...
@section('content')
    <div class="p-4 ml-64 bg-[#A7CCED]">
        <div class="mx-10 mb-5 p-8 w-lg bg-[#3a57b4] rounded-md flex justify-center">
            <h1 class="text-2xl text-white font-bold">Form Pengurangan Stok Sepatu</h1>
        </div>
        <div class="mx-10 p-8 w-lg bg-[#66a6df] rounded-md">
            <form action="{{ route('output-barang.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="my-3">
                    <input type="text" id="searchInputBarang" class="block w-full px-4 py-2 bg-white border text-sm border-gray-300 rounded-t-lg" placeholder="Cari Barang Disini......">
                    <select class="block w-full p-2 text-gray-900 border border-gray-300 rounded-b-lg bg-gray-50 text-sm" name="id_barang" id="id_barang" required>
                        <option class="p-2" value="">Pilih Barang di Search Input</option>
                ...
                <label class="text-sm font-semibold" for="costumers_id">Nama Customer :</label>
                <div class="my-3">
                    <input type="text" id="searchInputCustomer" class="block w-full px-4 py-2 text-sm bg-white border border-gray-300 rounded-t-lg" placeholder="Cari Costumer Disini.....">
                ...
                <label class="text-sm font-semibold" for="fotoInvoiceOutput">Upload Invoice :</label>
                ...
                <a href="/outputbarang" type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-auto px-5 py-2.5 text-center">Kembali</a>
            </form>
        </div>
    </div>
